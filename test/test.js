...
describe( 'series-boot-phase', function tests() {
	...
	it( 'should allow the series to be run multiple times (simultaneously)', function test( done ) {
		var phase,
			cnt;
	...
	it( 'should allow the series to be run multiple times (sequentially)', function test( done ) {
		var phase,
			cnt;
